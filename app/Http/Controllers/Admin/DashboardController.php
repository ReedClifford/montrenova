    ...
    <AuthenticatedLayout title="Watch Stocks">
        <div class="space-y-5 pb-72 sm:space-y-7 md:pb-0">
            ...
            <template v-if="activeTab === 'inventory'">
                ...
                <section
                    v-if="!isArrangeMode && viewMode === 'table' && displayedWatches.length"
                    ...
                    <div class="mb-3 flex items-end justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-1 text-xs leading-5 text-zinc-500">
                                {{ displayedWatches.length }} watch{{ displayedWatches.length === 1 ? '' : 'es' }} loaded. Swipe left or right to move between cards.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        >
                            <div class="relative bg-[#050505]">
                                ...
                                >
                                    {{ index + 1 }} / {{ displayedWatches.length }}
                                </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-4 rounded-2xl border p-3" :class="recommendedAction(watch).className">
                                    <p class="text-[11px] font-bold uppercase tracking-[0.16em]">
                                        {{ recommendedAction(watch).label }}
                                    </p>
