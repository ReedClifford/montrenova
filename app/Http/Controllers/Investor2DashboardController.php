...
use App\Models\Investor2;
use App\Models\InvestorSetting2;
...
class Investor2DashboardController extends Controller
{
    private const SETTING_KEY = 'main';

  private const START_DATE = '2026-07-28';
    ...
    public function updateSettings(
        ...
        abort_unless(
            $request->user()?->role
                === 'owner2',
            403,
            'Only owner2 can update the Brand Cut.'
        );
    ...
    public function updateInvestor(
        ...
        abort_unless(
            $request->user()?->role
                === 'owner2',
            403,
            'Only owner2 can update investors.'
        );
    ...
    public function destroyInvestor(
        ...
        abort_unless(
            $request->user()?->role
                === 'owner2',
            403,
            'Only owner2 can delete investors.'
        );
    ...
    private function getSettings(): InvestorSetting2
    {
        return InvestorSetting2::query()
            ->firstOrCreate(
                [
                    'setting_key' =>
                        self::SETTING_KEY,
